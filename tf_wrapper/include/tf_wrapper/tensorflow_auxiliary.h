...
#ifndef TF_WRAPPER_SEGMENTATION_TENSORFLOW_AUXILIARY_H
#define TF_WRAPPER_SEGMENTATION_TENSORFLOW_AUXILIARY_H
#define TFDEBUG
...
bool fastResizeIfPossible(const cv::Mat &in, cv::Mat *dist,
                          const cv::Size &size);
...
/// \param tensor
/// \return
bool convertMatToTensor_v2(const std::vector<cv::Mat> &imgs,
...
#endif // TF_WRAPPER_SEGMENTATION_TENSORFLOW_AUXILIARY_H
