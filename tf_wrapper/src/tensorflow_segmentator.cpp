...
// TODO Main objective is to remember about Batch
...
std::vector<cv::Mat>
TensorFlowSegmentator::convertTensorToMat(const tensorflow::Tensor &tensor) {
...
bool TensorFlowSegmentator::setInputOutput(std::vector<std::string> in_nodes,
